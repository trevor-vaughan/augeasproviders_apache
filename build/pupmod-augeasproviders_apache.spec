%define mod_name augeasproviders_apache

Summary: Apache Augeas-based providers for Puppet
Name: pupmod-augeasproviders_apache
Version: 2.0.1
Release: 0
...
%description
Apache Augeas-based providers for Puppet
